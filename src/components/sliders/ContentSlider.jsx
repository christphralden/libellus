...
export default function ContentSlider({ title, courses, category }) {
  return (
    <div className="w-full flex justify-center no-x">
      <div className="flex-col w-full">
        <div className="text-2xl text-d-text font-bold mb-4 mx-auto pl-6 md:pl-12 lg:pl-16 xl:pl-40 lg:text-3xl md:text-2xl">{title}</div>
